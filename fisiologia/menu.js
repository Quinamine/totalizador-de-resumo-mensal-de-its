...
const menu = {
    ...
    imprimirFicha() {
        ...
        let inputsCelulares = document.querySelectorAll("[data-total], [data-analise3ponto1], [data-analise4ponto6output]");
        let icPreenchidas = 0;
        let totalizadoPor;
...
function eventos() {
    ...
    // PARTILHAR 
    const data = {
        title: "Totalizador de Resumo Mensal de ITS",
        text: "Totaliza automaticamente o resumo mensal de ITS (Infecções de Transmissão Sexual) com base nos dados inseridos pelo usuário. Foi desenvolvido de acordo com o modelo da respectiva ficha de resumo mensal actualmente vigente no Serviço Nacional de Saúde em Moçambique.",
        url: "https://quinamine.github.io/totalizador-de-resumo-mensal-de-its/index.html"
    }
